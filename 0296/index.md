...
-   Prerequisites: [0282](../0282), [0351](../0351)
...
-   bit 52 to 62: these 11 bits are the 2's exponent. Let us define
    ...
    denotes the exponent of 2. Note how this calculation is similar to the definition of the $v_u$ function in [module 0351](../0351). 
...
-   bit 0 to 51: these 52 bits are the fractional base-2 mantissa. The
    ...
    the mantissa in base-2. Note how this calculation is related to, but not exactly the same as the computation of $v$ in [module 0282](../0282#common-base-multiple-digit-numbers).

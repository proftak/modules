...
In the Dashboard, click "Import repository", then specify `https://github.com/auyeunt/modules` as "the URL for your source repository". You can ignore the credential questions, but name your repository before clicking "Begin import."

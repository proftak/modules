...
[Time budgeting, management, and prioritization](../0417) are all crucial in the learning process. This module focuses on *how* to use the resource (time); read the linked module on how to plan to make sure the resource is available and used efficiently.

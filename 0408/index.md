---
title: "Module 0408: What's up with GitHub and Open Educational Resources?"
---
...
* Note the URL is not the viewing URL. To get the URL for importing from the web interface of a GitHub project, navigate to the top level of a repository, then click `<> Code`, and then copy the HTTPS. For example, the URL of the repository containing this document is `https://github.com/auyeunt/modules.git`.
